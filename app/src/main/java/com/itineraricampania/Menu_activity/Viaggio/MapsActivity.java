...
import com.itineraricampania.UpdatingLocationUser;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void startLocationService(){
        if(!isUpdatingLocationUser()){
            Intent serviceIntent = new Intent(this, UpdatingLocationUser.class);
    ...
    public void buildPlaces(Integer i,Place place){

        Place newPlace = new Place(
                place.getLuogoID(),
                place.getDataCreazione(),
                place.getRegione(),
                place.getProvincia(),
                place.getComune(),
                place.getLuogo(),
                ...
                place.getIndirizzo(),
                place.getCategoria(),
                place.getSottogategoria(),
                place.getDescrizione(),
                place.getOrari(),
                place.getInformazioni(),
                place.getTelefono(),
                place.getMail(),
                place.getSito(),
                place.getFacebook(),
